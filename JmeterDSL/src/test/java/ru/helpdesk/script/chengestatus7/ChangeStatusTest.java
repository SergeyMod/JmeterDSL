package ru.helpdesk.script.chengestatus7;
...
public class ChangeStatusTest {
    ...
    static final Logger logger = LogManager.getLogger(ChangeStatusTest.class);
    ...
    public void test() throws IOException, InterruptedException, TimeoutException {
        TestPlanStats stats = testPlan(
                ...
                getCookiesClean(),
                getCacheManager(),
                TreadGroup.getThreadGroup("TG_Change_Status", debugEnable)
                        .children(
