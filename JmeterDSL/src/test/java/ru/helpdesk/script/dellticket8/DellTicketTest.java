package ru.helpdesk.script.dellticket8;
...
public class DellTicketTest {
    ...
    static final Logger logger = LogManager.getLogger(DellTicketTest.class);
    ...
    public void test() throws IOException, InterruptedException, TimeoutException {
        TestPlanStats stats = testPlan(
                ...
                getCookiesClean(),
                getCacheManager(),
                AddUserTreadGroup.getThreadGroup("TG_Dell_Ticket", debugEnable)
                        .children(
