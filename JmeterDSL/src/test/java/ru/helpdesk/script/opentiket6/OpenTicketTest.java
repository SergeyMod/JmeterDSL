package ru.helpdesk.script.opentiket6;
...
import ru.helpdesk.script.opentiket6.fragments.OpenTicketsFragment;
...
public class OpenTicketTest {
    ...
    public void test() throws IOException, InterruptedException, TimeoutException {
        TestPlanStats stats = testPlan(
                ...
                getCookiesClean(),
                getCacheManager(),
                TreadGroup.getThreadGroup("TG_Open_Ticket", debugEnable)
                        .children(
                                AdminLoginFragment.get(),
                                AddUsersFragment.get(),
                                LogoutFragment.get(),
                                LoginFragment.get(),
                                OpenTicketsFragment.get()
                                ),
