package ru.helpdesk.script.createticket3;
...
public class CreateTicketTest {
    ...
    static final Logger logger = LogManager.getLogger(CreateTicketTest.class);
    ...
    public void test() throws IOException, InterruptedException, TimeoutException {
        TestPlanStats stats = testPlan(
                ...
                getCookiesClean(),
                getCacheManager(),
                TreadGroup.getThreadGroup("TG_Create_Ticket", debugEnable)
                        .children(
