    ...
    public static DslTransactionController get() {
        return transaction("TC_AddUsers2",
                        ...
                        httpSampler(">_/admin/auth/user/add/", "${protocol}://${host}:${port}/admin/auth/user/add/")
                                ...
                                .children(
                                        jsr223PreProcessor("vars.put(\"username2\", \"${__RandomString(10, 1234567890abcdefghiklmnopqrstuvwxyz-,)}\")\n"
                                                + "\n"
                                                + "vars.put(\"password2\", \"${__RandomString(8,1234567890abcdefghiklmnopqrstuvwxyz-,)}\")"),
